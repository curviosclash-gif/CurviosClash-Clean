...
test('classic and modern arena materials keep their distinct art direction', () => {
    ...
    assert.equal(classic.wallMat.defines.ATMOSPHERIC_FOG_ALPHA_FADE, 1);
    assert.equal(classic.floorMat.transparent, true);
    assert.equal(classic.floorMat.depthWrite, true);
    assert.equal(classic.floorMat.defines.ATMOSPHERIC_FOG_ALPHA_FADE, 1);
    ...
    assert.equal(modern.wallMat.defines.ATMOSPHERIC_FOG_ALPHA_FADE, 1);
    assert.equal(modern.floorMat.transparent, true);
    assert.equal(modern.floorMat.depthWrite, true);
    assert.equal(modern.floorMat.defines.ATMOSPHERIC_FOG_ALPHA_FADE, 1);
