...
const KINETIC_TIDE_OBSTACLES = [
    ...
    { pos: [2, 62, -4], size: [14, 3, 12] },
    { pos: [16, 64, 0], size: [18, 4, 18] },
    ...
    { pos: [96, 100, 98], size: [22, 4, 20] },
    { pos: [64, 94, 88], size: [16, 3, 15] },
    { pos: [30, 86, 70], size: [18, 4, 17] },
    { pos: [4, 78, 48], size: [15, 3, 14] },
    { pos: [-6, 70, 30], size: [16, 4, 15] },
    { pos: [-4, 66, 12], size: [14, 3, 13] },
    { pos: [0, 60, 0], size: [24, 4, 22] },
