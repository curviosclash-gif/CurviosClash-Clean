...
const AETHERION_CHECKPOINTS = [
    ...
    { id: 'CP03_SAFE', params: { label: 'Aussenring unten', color: 0x4da6ff }, type: 'outer_safe', pos: [-122, 30, -60], radius: 6.0, forward: [-0.7, 0.02, 0.7], nextIds: ['CP04'] },
    ...
    { id: 'CP06_SAFE', params: { label: 'Aussenring Mitte', color: 0x4da6ff }, type: 'outer_safe', pos: [128, 100, 88], radius: 6.0, forward: [0.68, 0.2, 0.71], nextIds: ['CP07'] },
    ...
    { id: 'CP09_SAFE', params: { label: 'Aussenring oben', color: 0x4da6ff }, type: 'outer_safe', pos: [-138, 154, 40], radius: 6.0, forward: [-0.87, 0.06, -0.49], nextIds: ['CP10'] },
    { id: 'CP09_FAST', params: { label: 'Eklipse direkt', color: 0xffbf45 }, type: 'eclipse_fast', pos: [-30, 154, 18], radius: 4.6, forward: [0.25, 0, -0.97], nextIds: ['CP10'] },
