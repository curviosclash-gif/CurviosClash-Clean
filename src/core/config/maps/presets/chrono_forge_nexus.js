...
const CHRONO_FORGE_CHECKPOINTS = [
    ...
    // Before the crystal mass, which covered almost the whole ring disc.
                { id: 'CP07', type: 'crystal_tunnel', pos: [66, 63, 45], radius: 5.2, forward: [0.9, 0.1, 0.2] },
    ...
    // Clear of the fast lane's rock: the old centre never came free.
                { id: 'CP09_FAST', type: 'fast_orange', pos: [116, 77, 82], radius: 4.6, forward: [0.7, 0.3, 0.7], nextIds: ['CP10'] },
