...
export const STORM_DAM_SECRET_ROOM_OBSTACLES = Object.freeze([
...
export const STORM_DAM_SECRET_ROOM = Object.freeze({
    ...
    unlock: Object.freeze({ destructible: 'storm_dam', when: 'anyBreak', delaySeconds: 4 }),
    stayLimitSeconds: 20,
    refillSeconds: 30,
    entryPortal: Object.freeze({ pos: Object.freeze([0, 12, -62]), color: 0x5ee5ff }),
    ...
    ejectPoint: Object.freeze({ pos: Object.freeze([0, 18, -70]), yawDeg: 180 }),
    items: ITEMS,
});
