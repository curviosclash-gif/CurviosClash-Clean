...
export async function selectJoinSignalingUrlFromDiscoveredHosts(options = {}) {
    ...
    if (validatedHosts.length > 1) {
        return {
            ...
            issue: {
                ...
                message: `Mehrere LAN-Hosts für Lobby-Code ${lobbyCode} gefunden. Bitte Host-IP:Port direkt eingeben oder Discovery kurz neu starten.`,
                details: {
                    lobbyCode,
    ...
    return {
        ...
        issue: {
            ...
            message: `Gefundene LAN-Hosts für ${lobbyCode} antworten nicht mehr. Vermutlich stale Broadcast oder Portwechsel; Host bitte neu announcen oder IP:Port direkt eingeben.`,
            details: {
                lobbyCode,
