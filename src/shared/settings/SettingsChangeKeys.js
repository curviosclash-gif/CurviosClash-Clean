export const SETTINGS_CHANGE_KEYS = Object.freeze({
    ...
    LAN_HOST_LOCAL_PLAYER_COUNT: 'multiplayer.hostLocalPlayerCount',
    ...
    ARCADE_INTERMISSION_SECONDS: 'arcade.intermissionSeconds',
    ARCADE_COMBO_DECAY: 'arcade.comboDecayPerSecond',
    ARCADE_REPLAY_HOOKS: 'arcade.replayHooksEnabled',
    ...
    LOCAL_AUDIO_SFX_VOLUME: 'local.audio.sfxVolume',
    LOCAL_AUDIO_ENGINE_VOLUME: 'local.audio.engineVolume',
    LOCAL_AUDIO_UI_VOLUME: 'local.audio.uiVolume',
    LOCAL_AUDIO_AMBIENCE_VOLUME: 'local.audio.ambienceVolume',
    LOCAL_HUD_SCALE: 'local.hud.scale',
    LOCAL_HUD_OPACITY: 'local.hud.opacity',
    LOCAL_HUD_COLOR_PRESET: 'local.hud.colorPreset',
    ...
    LOCAL_MOBILE_TILT_DEBUG_VISIBLE: 'local.mobileControls.tiltDebugVisible',
    LOCAL_MOBILE_TILT_SENSOR_HZ_VISIBLE: 'local.mobileControls.tiltSensorHzVisible',
    MODE: 'mode',
    GAME_MODE: 'gameMode',
    MAP_KEY: 'mapKey',
    ...
    BOTS_HEURISTIC_PROFILE: 'bots.heuristicProfile',
    BOTS_HEURISTIC_TUNING: 'bots.heuristicTuning',
    ...
    RULES_INVERT_P3: 'rules.invertPitch.player3',
...
const CHANGE_KEY_PATH_OVERRIDES = Object.freeze({
    ...
    [SETTINGS_CHANGE_KEYS.LAN_HOST_LOCAL_PLAYER_COUNT]: 'localSettings.lanHostLocalPlayerCount',
    ...
    [SETTINGS_CHANGE_KEYS.BOTS_HEURISTIC_PROFILE]: 'botHeuristicProfile',
    [SETTINGS_CHANGE_KEYS.BOTS_HEURISTIC_TUNING]: 'botHeuristicTuning',
    [SETTINGS_CHANGE_KEYS.RULES_WINS_NEEDED]: 'winsNeeded',
    [SETTINGS_CHANGE_KEYS.RULES_AUTO_ROLL]: 'autoRoll',
    [SETTINGS_CHANGE_KEYS.RULES_INVERT_P1]: 'invertPitch.PLAYER_1',
    [SETTINGS_CHANGE_KEYS.RULES_INVERT_P2]: 'invertPitch.PLAYER_2',
    [SETTINGS_CHANGE_KEYS.RULES_INVERT_P3]: 'invertPitch.PLAYER_3',
    [SETTINGS_CHANGE_KEYS.RULES_COCKPIT_P1]: 'cockpitCamera.PLAYER_1',
    [SETTINGS_CHANGE_KEYS.RULES_COCKPIT_P2]: 'cockpitCamera.PLAYER_2',
    [SETTINGS_CHANGE_KEYS.RULES_PORTALS_ENABLED]: 'portalsEnabled',
    [SETTINGS_CHANGE_KEYS.VEHICLES_PLAYER_1]: 'vehicles.PLAYER_1',
    [SETTINGS_CHANGE_KEYS.VEHICLES_PLAYER_2]: 'vehicles.PLAYER_2',
