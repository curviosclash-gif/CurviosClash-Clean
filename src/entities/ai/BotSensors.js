...
// Ein Wurf genau in der Mitte: keine Fehlerstreuung, keine Richtungsvorliebe. Das ist
// der reproduzierbare Ersatz fuer einen Wuerfel, der noch nicht gebunden ist.
const NEUTRAL_SENSOR_ROLL = () => 0.5;
...
export class BotSensors {
    constructor() {
        ...
        // deshalb traegt sie den Wuerfel der gebundenen BotAI mit. Solange kein Bot
        // gebunden ist, gibt es keinen gesetzten Wuerfel: ein konstanter Wurf haelt die
        // Sensorik reproduzierbar, statt still auf den globalen Zufall auszuweichen.
        this._random = NEUTRAL_SENSOR_ROLL;
    ...
    _bindRuntime(bot) {
        ...
        this._random = typeof bot._random === 'function' ? bot._random : NEUTRAL_SENSOR_ROLL;
