...
export class EntityManager {
    ...
    _teardownRuntime({ disposeProjectileSystem = false } = {}) {
        ...
        this._mapHazardSystem?.clear?.(); this._mapDestructibleSystem?.clear?.(); if (disposeProjectileSystem) { this._mapUnitSystem?.dispose?.(); this._lightningStrikeSystem?.dispose?.(); } else { this._mapUnitSystem?.clear?.(); this._lightningStrikeSystem?.reset?.(); } this._mapDestructibleBlastSystem?.clear?.(); if (disposeProjectileSystem) this._exclusionZoneSystem?.dispose?.(); else this._exclusionZoneSystem?.reset?.();
