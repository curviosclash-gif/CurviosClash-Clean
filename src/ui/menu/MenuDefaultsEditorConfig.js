    ...
    fixedPresets: [
        {
            id: 'endlosjagd',
            name: 'Endlosjagd',
            description: 'Endloser Kampf-Parcours: Tore geben Punkte, Serie und eine Rettung; die Strecke knickt, Schleusen takten, Anführer ruecken nach.',
...
export function createMenuDefaultsEditorSnapshotFromSettings(settings = {}) {
    ...
    return {
        ...
        localSettings: {
            ...
            smoothSteering: localSettings.smoothSteering === true,
