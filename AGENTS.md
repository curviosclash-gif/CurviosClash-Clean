...
26. Höchstens drei Sitzungen arbeiten gleichzeitig an diesem Repository. Prüfe vor Beginn einer schreibenden Aufgabe mit `git worktree list` und dem Playwright-Schloss, wie viele Arbeiten schon laufen. Sind es bereits drei, starte nicht, sondern melde es dem Nutzer und schlage vor, welche offene Arbeit zuerst abgeschlossen werden sollte. Starte Subagenten mit einer festen Obergrenze, nie „so viele wie möglich".
