...
34. Redundanz-Schwellwerte: Ein Finding gilt als hochkonfident wenn 4+ der 5 fb-Modelle im Council-Review uebereinstimmen. Ein 🔴-Finding gilt als bestaetigt nur wenn BEIDE Verify-Laeufe TRUE liefern. Disagree zwischen Verify-Laeufen → "nicht verifizierbar".
